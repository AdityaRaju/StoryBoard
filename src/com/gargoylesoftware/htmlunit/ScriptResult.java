...
public final class ScriptResult {
    ...
    /**
     * Creates and returns a composite {@link com.gargoylesoftware.htmlunit.ScriptResult} based on the two input {@link com.gargoylesoftware.htmlunit.ScriptResult}s. This
     ...
     *
     * @param newResult the new {@link com.gargoylesoftware.htmlunit.ScriptResult} (may be <tt>null</tt>)
     * @param originalResult the original {@link com.gargoylesoftware.htmlunit.ScriptResult} (may be <tt>null</tt>)
     * @param ie whether or not we are emulating IE
     * @return a composite {@link com.gargoylesoftware.htmlunit.ScriptResult}, based on the two input {@link com.gargoylesoftware.htmlunit.ScriptResult}s
     */
