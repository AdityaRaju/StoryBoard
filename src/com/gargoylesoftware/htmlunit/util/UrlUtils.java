...
//        allowedFragment.clear('%');
     ...
     * this method never expects to have to handle {@link java.net.MalformedURLException}s.</p>
     *
     ...
     * @param url the URL string to convert into a URL instance
     * @return the constructed URL instance
     * @throws java.net.MalformedURLException if the URL string cannot be converted to a URL instance
     */
     ...
     * @deprecated as of 2.12, please use {@link #encodeUrl(java.net.URL, boolean, String)} instead
     */
    @Deprecated
     ...
     * @throws java.net.MalformedURLException if there is a problem creating the new URL
     */
