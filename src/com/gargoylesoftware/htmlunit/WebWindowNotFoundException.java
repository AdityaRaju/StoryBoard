...
/**
 * Exception to indicate that no {@link com.gargoylesoftware.htmlunit.WebWindow} could be found that matched
 * a given name.
 *
...
public class WebWindowNotFoundException extends RuntimeException {
    ...
    /**
     * Returns the name of the {@link com.gargoylesoftware.htmlunit.WebWindow} that wasn't found.
     * @return the name
     */
