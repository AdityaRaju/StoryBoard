...
public class JavaScriptEngine {
    ...
    /**
     * Key used to place the {@link com.gargoylesoftware.htmlunit.html.HtmlPage} for which the JavaScript code is executed
    ...
    private void init(final WebWindow webWindow, final Context context) throws Exception {
        ...
        for (final Entry<String, ScriptableObject> entry : prototypesPerJSName.entrySet()) {
     ...
     * @param c the node class {@link com.gargoylesoftware.htmlunit.html.DomNode} or some subclass.
