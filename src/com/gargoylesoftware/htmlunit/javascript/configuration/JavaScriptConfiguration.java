...
public final class JavaScriptConfiguration {
    ...
    /**
     * Constructor is only called from {@link #getInstance(com.gargoylesoftware.htmlunit.BrowserVersion)} which is synchronized.
    ...
    /**
     * Returns the instance that represents the configuration for the specified {@link com.gargoylesoftware.htmlunit.BrowserVersion}.
     * This method is synchronized to allow multi-threaded access to the JavaScript configuration.
     * @param browserVersion the {@link com.gargoylesoftware.htmlunit.BrowserVersion}
     * @return the instance for the specified {@link com.gargoylesoftware.htmlunit.BrowserVersion}
     */
