...
/**
 * The ArrayBufferView type describes a particular view on the contents of an {@link com.gargoylesoftware.htmlunit.javascript.host.arrays.ArrayBuffer}'s data.
 *
...
public class ArrayBufferView extends SimpleScriptable {
    ...
    /**
     * Returns the offset, in bytes, to the first byte of the view within the {@link com.gargoylesoftware.htmlunit.javascript.host.arrays.ArrayBuffer}.
     * @return the offset
     */
    @JsxGetter
