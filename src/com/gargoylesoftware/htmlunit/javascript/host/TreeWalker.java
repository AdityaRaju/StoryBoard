...
public class TreeWalker extends SimpleScriptable {
     ...
     *          logical view of the TreeWalker. See {@link com.gargoylesoftware.htmlunit.javascript.host.NodeFilter} for the
     *          set of possible Show_ values.
     * @param filter The {@link com.gargoylesoftware.htmlunit.javascript.host.NodeFilter} to be used with this TreeWalker,
     ...
     * @throws org.w3c.dom.DOMException on attempt to create a TreeWalker with a root that
     *          is <code>null</code>.
     */
     ...
     * of available constants is defined in {@link com.gargoylesoftware.htmlunit.javascript.host.NodeFilter}.
     *
     ...
     *          TreeWalker.
     * @throws org.w3c.dom.DOMException on attempt to set currentNode to
     *          <code>null</code>.
     */
    @JsxSetter
    ...
    /**
     * Given a node type, as defined in {@link com.gargoylesoftware.htmlunit.javascript.host.Node}, return the appropriate
