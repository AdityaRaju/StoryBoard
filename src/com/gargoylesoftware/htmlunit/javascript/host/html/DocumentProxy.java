...
/**
 * Proxy for a {@link com.gargoylesoftware.htmlunit.javascript.host.Document} script object. In theory we could satisfy single-document requirements
 * without a proxy, by reusing (with appropriate cleanup and re-initialization) a single {@link com.gargoylesoftware.htmlunit.javascript.host.Document}
...
public class DocumentProxy extends SimpleScriptableProxy<Document> {
    ...
    /**
     * Construct a proxy for the {@link com.gargoylesoftware.htmlunit.javascript.host.Document} of the {@link WebWindow}.
