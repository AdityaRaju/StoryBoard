...
public class DataUrlDecoder {
     ...
     * @return the {@link com.gargoylesoftware.htmlunit.protocol.data.DataUrlDecoder} holding decoded information
     * @throws java.io.UnsupportedEncodingException if the encoding specified by the data URL is invalid or not
     ...
     * @throws java.io.UnsupportedEncodingException if decoding failed using the specified charset
     */
