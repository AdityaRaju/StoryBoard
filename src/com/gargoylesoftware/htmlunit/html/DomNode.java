...
public abstract class DomNode implements Cloneable, Serializable, Node {
     ...
     * @throws org.w3c.dom.DOMException HIERARCHY_REQUEST_ERR: Raised if this node is of a type that does
     ...
     * including {@link DomText} elements, {@link com.gargoylesoftware.htmlunit.html.DomComment} elements, etc. If you want to iterate
     ...
     * {@link com.gargoylesoftware.htmlunit.html.DomComment} elements, etc.), please use {@link #getDescendants()}.
    ...
    /**
     * Adds a {@link com.gargoylesoftware.htmlunit.html.DomChangeListener} to the listener list. The listener is registered for
     * all descendants of this node.
     *
     * @param listener the DOM structure change listener to be added
     * @see #removeDomChangeListener(com.gargoylesoftware.htmlunit.html.DomChangeListener)
     */
    ...
    /**
     * Removes a {@link com.gargoylesoftware.htmlunit.html.DomChangeListener} from the listener list. The listener is deregistered for
     * all descendants of this node.
     *
     * @param listener the DOM structure change listener to be removed
     * @see #addDomChangeListener(com.gargoylesoftware.htmlunit.html.DomChangeListener)
     */
     ...
     * will send the appropriate {@link com.gargoylesoftware.htmlunit.html.DomChangeEvent} to any registered {@link com.gargoylesoftware.htmlunit.html.DomChangeListener}s.
     *
     * Note that this method recursively calls this node's parent's {@link #fireNodeAdded(com.gargoylesoftware.htmlunit.html.DomNode, com.gargoylesoftware.htmlunit.html.DomNode)}.
     *
     ...
     * will send the appropriate {@link com.gargoylesoftware.htmlunit.html.DomChangeEvent} to any registered {@link com.gargoylesoftware.htmlunit.html.DomChangeListener}s.
     *
     * Note that this method recursively calls this node's parent's {@link #fireNodeDeleted(com.gargoylesoftware.htmlunit.html.DomNode, com.gargoylesoftware.htmlunit.html.DomNode)}.
     *
     ...
     * @see HtmlScript#processImportNode(org.w3c.dom.Document)
     */
