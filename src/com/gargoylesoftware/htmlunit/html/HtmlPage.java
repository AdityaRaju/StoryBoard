 ...
 * </p>
 * <p>
 * Child elements allowing user interaction provide methods for this purpose like {@link com.gargoylesoftware.htmlunit.html.HtmlAnchor#click()},
 * {@link com.gargoylesoftware.htmlunit.html.HtmlInput#type(String)}, {@link com.gargoylesoftware.htmlunit.html.HtmlOption#setSelected(boolean)}, ...
 * </p>
 * <p>
...
public class HtmlPage extends SgmlPage {
    ...
    /**
     * Returns the {@link com.gargoylesoftware.htmlunit.html.HtmlAnchor} with the specified name.
     *
     * @param name the name to search by
     * @return the {@link com.gargoylesoftware.htmlunit.html.HtmlAnchor} with the specified name
    ...
    /**
     * Returns the {@link com.gargoylesoftware.htmlunit.html.HtmlAnchor} with the specified href.
     *
     ...
     * @return the list of {@link com.gargoylesoftware.htmlunit.html.HtmlAnchor} in this page
     */
     ...
     * @throws com.gargoylesoftware.htmlunit.ElementNotFoundException if no anchors are found with the specified text
     */
     ...
     * @exception com.gargoylesoftware.htmlunit.ElementNotFoundException If no forms match the specified result.
     */
    ...
    */
     ...
     * @throws com.gargoylesoftware.htmlunit.FailingHttpStatusCodeException if the request's status code indicates a request
     ...
     * @throws java.io.IOException if there is a problem downloading the JavaScript file
     * @throws com.gargoylesoftware.htmlunit.FailingHttpStatusCodeException if the request's status code indicates a request
     *         failure and the {@link WebClient} was configured to throw exceptions on failing
     *         HTTP status codes
     */
     ...
     * @return a list of {@link com.gargoylesoftware.htmlunit.html.FrameWindow}
     */
     ...
     * @exception com.gargoylesoftware.htmlunit.ElementNotFoundException If no frame exist in this page with the specified name.
     */
     ...
     * has the focus.
     * @throws java.io.IOException if an IO error occurs during the processing of this access key (this
     ...
     * order, refer to {@link com.gargoylesoftware.htmlunit.html.HtmlPage#getTabbableElements()}
     *
     ...
     * @throws com.gargoylesoftware.htmlunit.ElementNotFoundException if no element was found matching the specified ID
     */
     ...
     * @throws com.gargoylesoftware.htmlunit.ElementNotFoundException if no element was found matching the specified name
     */
    @SuppressWarnings("unchecked")
     ...
     * @see WebAssert#assertAllTabIndexAttributesSet(com.gargoylesoftware.htmlunit.html.HtmlPage)
     */
     ...
     * @see #setFocusedElement(com.gargoylesoftware.htmlunit.html.HtmlElement)
     */
     ...
     * @return a list of {@link com.gargoylesoftware.htmlunit.html.HtmlMeta}
     */
     ...
     * @see #removeHtmlAttributeChangeListener(com.gargoylesoftware.htmlunit.html.HtmlAttributeChangeListener)
     */
     ...
     * @see #addHtmlAttributeChangeListener(com.gargoylesoftware.htmlunit.html.HtmlAttributeChangeListener)
     */
