...
public class WebRequest implements Serializable {
    ...
    /**
     * Instantiates a {@link com.gargoylesoftware.htmlunit.WebRequest} for the specified URL.
    ...
    /**
     * Instantiates a {@link com.gargoylesoftware.htmlunit.WebRequest} for the specified URL using the proxy configuration from the
    ...
    /**
     * Instantiates a {@link com.gargoylesoftware.htmlunit.WebRequest} for the specified URL using the specified HTTP submit method.
     * @param url the target URL
     ...
     * types. Should not be used in combination with {@link #setRequestParameters(java.util.List) request parameters}.
     ...
     * Should not be used in combination with {@link #setRequestParameters(java.util.List) request parameters}.
     ...
     * is {@link com.gargoylesoftware.htmlunit.TextUtil#DEFAULT_CHARSET}.
