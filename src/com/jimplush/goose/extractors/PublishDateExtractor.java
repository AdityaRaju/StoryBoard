...
/**
 * Implement this class to extract the {@link java.util.Date} of when this article was published.
 */
public abstract class PublishDateExtractor implements Extractor<Date> {

  /**
   * Intended to search the DOM and identify the {@link java.util.Date} of when this article was published.
   ...
   * @return {@link java.util.Date} of when this particular article was published or <code>null</code> if no date could be found.
   */
